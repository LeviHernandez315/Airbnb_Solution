...
using Aplication.Interfaces.EntitiesInterfaces.AreaTrabajoInterfaces;
using System;
...
namespace Aplication.Services.EntitiesServices
{
    public class AreaTrabajoService : IAreaTrabajoService
    {
        ...
        {
            var areasTrabajo = new Domain.Entities.AreaTrabajo();
